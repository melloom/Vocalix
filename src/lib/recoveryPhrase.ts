 ...
 * 
 * Generates and manages recovery phrases for device transfer
 * Uses a word list for memorable phrases (like "correct horse battery staple")
 */

// BIP39-inspired word list (simplified, 256 words for 8-bit combinations)
// Using common, easy-to-remember words
const WORD_LIST = [
  ...
  "card", "care", "career", "careful", "careless", "cargo", "carpet", "carry",
  "cart", "case", "cash", "casino", "cast", "casual", "cat", "catalog",
  ...
  "enlist", "enough", "enrich", "enroll", "ensure", "enter", "enterprise", "entertain",
  "enthusiasm", "entire", "entry", "envelope", "episode", "equal", "equip", "era",
  "erase", "erode", "erosion", "error", "erupt", "escape", "essay", "essence",
  "establish", "estate", "eternal", "ethics", "evidence", "evil", "evoke", "evolve",
  "exact", "example", "exceed", "excellent", "except", "excess", "exchange", "excite",
  ...
  "peace", "peach", "peanut", "pear", "peasant", "pelican", "pen", "penalty",
  ...
  "recipe", "record", "recover", "recycle", "reduce", "reflect", "reform", "refuse",
  ...
  "word", "work", "world", "worry", "worth", "would", "wound", "wrangle",
  "wrap", "wreck", "wrestle", "wrist", "write", "wrong", "yard", "year",
  "yellow", "you", "young", "youth", "zebra", "zero", "zone", "zoo"
];

/**
 * Generate a random recovery phrase (4 words)
 * Returns a phrase like "correct horse battery staple"
 */
...
/**
 * Normalize a recovery phrase (trim, lowercase, remove extra spaces)
 */
...
/**
 * Validate recovery phrase format (4 words, all in word list)
 */
export function validateRecoveryPhrase(phrase: string): { valid: boolean; error?: string } {
  const normalized = normalizeRecoveryPhrase(phrase);
  const words = normalized.split(" ");

  if (words.length !== 4) {
    return { valid: false, error: "Recovery phrase must contain exactly 4 words" };
  }

  for (const word of words) {
    if (!WORD_LIST.includes(word)) {
      return { valid: false, error: `"${word}" is not a valid word in the recovery phrase` };
    }
  }
