    ...
    <SelectPrimitive.Portal>
      <SelectPrimitive.Content
        ...
        className={cn(
          ...
          isMobile 
            ? "fixed bottom-0 left-0 right-0 max-h-[60vh] rounded-t-xl rounded-b-none border-b-0 data-[state=closed]:slide-out-to-bottom data-[state=open]:slide-in-from-bottom"
