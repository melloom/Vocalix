...
const faqData: FAQItem[] = [
  ...
  },
  {
    ...
    answer: "Currently, you can't edit clips after publishing. However, you can delete and re-record if needed. We're working on editing features for future updates. You can always delete a clip and create a new one with your changes.",
    icon: Settings,
    tags: ["edit", "modify", "change", "update", "delete"],
  },
  {
    id: "delete-clips",
    category: "Recording & Clips",
  ...
  },
  {
    ...
    answer: "Yes! Vocalix has an offline mode. You can download clips for offline listening. Go to any clip and click the download button. Downloaded clips are stored locally on your device and can be accessed even without an internet connection.",
    icon: Download,
    tags: ["offline", "download", "listen", "internet"],
  },
  {
    id: "background-playback",
    category: "Features",
    question: "Can I listen while using other apps?",
    answer: "Yes! Vocalix supports background playback. You can minimize the app or switch to other apps while audio continues playing. The audio player controls appear in your device's media controls, so you can pause, play, or skip without opening Vocalix.",
    icon: PlayCircle,
    tags: ["background", "playback", "multitask", "media controls"],
  },
  {
    id: "playback-speed",
    category: "Features",
    question: "Can I change playback speed?",
    answer: "Yes! You can adjust playback speed to 0.5x, 1x, 1.5x, or 2x. Your speed preference is saved and will be used for all clips. This is great for listening to longer clips or catching up on content faster.",
    icon: Volume2,
    tags: ["playback speed", "speed", "1.5x", "2x", "faster"],
  },
  ...
  },
  {
    ...
    answer: "Voice Search lets you search using your voice instead of typing. Click the microphone icon in the search bar, speak your search query, and Vocalix will find clips matching what you said. It's powered by the same transcription technology that makes all clips searchable.",
    icon: Mic,
    tags: ["voice search", "speak", "audio search", "microphone"],
  },
  {
    id: "discover-content",
    category: "Search & Discovery",
  ...
  },
  {
    ...
    answer: "Currently, handles cannot be changed after account creation. This helps maintain consistency and prevents impersonation. If you need a different handle, you'll need to create a new account. We're working on handle changes for verified accounts in the future.",
    icon: Settings,
    tags: ["handle", "username", "change", "modify"],
  },
  {
    id: "notifications",
    category: "Account & Settings",
  ...
  },
  {
    ...
    answer: "Remixing lets you create new content by combining your voice with an existing clip. You can add your voice overlay, create duets, or build on someone else's clip. Remixes are credited to both the original creator and you, creating collaborative audio content.",
    icon: Music,
