...
- **Site Key** (Frontend): `6LdrJBcsAAAAAKWjfoIW-YDTcHH9g9N5S2Zb8cYH` ← This is public, goes in Netlify
...
|----------|-------|-------|---------|
| `VITE_RECAPTCHA_SITE_KEY` | Site Key | Netlify (frontend) | `6LdrJBcsAAAAAKWjfoIW-YDTcHH9g9N5S2Zb8cYH` |
...
| `RECAPTCHA_SITE_KEY` | Site Key | Supabase (backend) | `6LdrJBcsAAAAAKWjfoIW-YDTcHH9g9N5S2Zb8cYH` |
...
4. The Site Key starts with `6Ldr` (reCAPTCHA format)
...
└── echo-garden-479222 (Project)
    ...
    └── Use in:
        ...
        └── Netlify Env Var: VITE_RECAPTCHA_SITE_KEY = 6Ldr...
```
